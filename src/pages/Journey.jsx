...
const milestones = [
  ...
  },
  {
    ...
    achievements: ['Improved API performance by 25%', 'Increased test coverage by 40%', 'Reduced deployment time by 60%'],
  ...
  },
  {
    ...
    achievements: ['Improved ETL efficiency by 30%', 'Reduced manual reporting time by 50%', 'Enhanced data quality by 25%'],
  ...
  },
  {
    ...
    tag: 'Current',
    description: "Engineered automated pricing system for 100K+ products. Converted Terraform to CloudFormation, automated EKS provisioning, and implemented full-stack observability.",
    achievements: ['100K+ products priced via automation', '70% less manual infra work', '50% faster incident response'],
    skills: ['Python', 'AWS Lambda', 'Terraform', 'CloudFormation', 'Ansible', 'EKS', 'CloudWatch', 'Snowflake', 'Power BI'],
  },
];
    ...
    <div className="min-h-screen overflow-hidden" style={{ background: 'var(--bg)' }}>
      ...
      <section className="relative pt-32 pb-16 px-6 lg:px-16 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            {[
              { year: '2025', label: 'Software Engineer @ Source Consulting', color: 'var(--accent)' },
