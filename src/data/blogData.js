...
<article class="prose lg:prose-xl max-w-none mx-auto p-6">
  <h1 class="mb-6 text-3xl md:text-4xl lg:text-5xl font-extrabold tracking-tight text-gray-900 text-center relative">
    The Code Behind the Canvas: How I Engineered My Personal Portfolio with React, Tailwind & Analytics
    <span class="block w-24 h-1 bg-[#e13a7a] rounded-full mx-auto mt-4"></span>
  </h1>
