                ...
                <div className="max-w-7xl mx-auto">
                  <div className="bg-white rounded-2xl shadow p-8 text-gray-900 flex flex-col items-center">
                    ...
                    <div className="flex flex-wrap gap-3 justify-center">
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Python</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Java</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">C#/.NET</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">JavaScript (Node.js)</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">SQL</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">HTML</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">CSS</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">MySQL</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">SQL Server</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Hadoop</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Apache Spark</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Apache Hive</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Apache Pig</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">AWS</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Microsoft Azure</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Docker</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Kubernetes</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Git</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Azure Data Factory</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">UiPath RPA</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Tableau</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Power BI</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Microsoft Power Platform</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Informatica PowerCenter</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">RESTful APIs</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Microservices</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Kafka</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Penetration Testing</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Cryptographic Algorithms</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Linux Shell Scripting</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Visual Studio</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Visual Studio Code</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Postman</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">JIRA</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Microsoft Office Suite</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Windows</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Linux</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Ubuntu</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">macOS</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Network Troubleshooting</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">IP Addressing</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Wireless Networking</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Network Configuration</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">IoT</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Ultrasonic Sensors</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Raspberry Pi</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Agile</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Data Visualization</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">ETL Pipelines</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">System Integration</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Big Data Technologies</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Data Analytics</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Cloud-Based Solutions</span>
                      <span className="bg-[#e13a7a] text-white font-semibold px-4 py-2 rounded-full shadow-sm">Secure Backend Architectures</span>
                    </div>
                  </div>
                </div>
              </section>
