        ...
        >
          <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="relative">
                  ...
                  {field.type === 'textarea' ? (
                    <textarea
                      ...
                      rows="5"
                      className="w-full pl-12 pr-4 py-4 bg-gray-800 border-2 border-gray-700 rounded-lg text-white placeholder-gray-400 focus:border-gray-900 focus:outline-none transition-all duration-300 resize-none"
                      required
                    />
                  ) : (
                    <input
                      ...
                      onBlur={() => setFocusedField(null)}
                      placeholder={field.label}
                      className="w-full pl-12 pr-4 py-4 bg-gray-800 border-2 border-gray-700 rounded-lg text-white placeholder-gray-400 focus:border-gray-900 focus:outline-none transition-all duration-300"
                      required
                    />
                  )}
                  ...
                  >
                    <div className="absolute inset-0 rounded-lg border-2 border-gray-900 opacity-50" />
                  </motion.div>
                </div>
              </motion.div>
            ))}
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full bg-gradient-to-r from-gray-900 to-gray-800 text-white py-4 px-8 rounded-lg font-bold text-lg flex items-center justify-center gap-3 hover:from-gray-800 hover:to-gray-900 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        >
          {[
            ...
            <motion.div
              ...
              className="bg-gray-800 p-6 rounded-lg border border-gray-700 text-center hover:border-gray-900 transition-colors duration-300"
            >
                             <info.icon className="text-3xl text-gray-900 mx-auto mb-3" />
              <h3 className="text-white font-semibold mb-1">{info.label}</h3>
              {info.href ? (
                                 <a href={info.href} className="text-gray-400 hover:text-gray-900 transition-colors duration-300">
                  {info.value}
                </a>
              ) : (
